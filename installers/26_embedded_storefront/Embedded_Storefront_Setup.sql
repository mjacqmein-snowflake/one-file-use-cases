...
BEGIN
 ...
 -- work, and it is the reason the buttons looked like they needed a terminal.
  ...
  LET portable_source_revision STRING := '90d986226f60d975';
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/.streamlit/config.toml FROM (SELECT REPLACE(BASE64_DECODE_STRING(''W3Nub3dmbGFrZV0KW3Nub3dmbGFrZS5zbGVlcF0Kc3RyZWFtbGl0U2xlZXBUaW1lb3V0TWludXRlcyA9IF9fUE9SVEFCTEVfU0xFRVBfTUlOVVRFU19fCg==''), ''__PORTABLE_SLEEP_MINUTES__'', LEAST(240, GREATEST(5, COALESCE(TRY_TO_NUMBER($STOREFRONT_APP_SLEEP_MINUTES::VARCHAR), 240)))::VARCHAR)) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/environment.yml FROM (SELECT BASE64_DECODE_STRING(''bmFtZTogc2ZfZW52CmNoYW5uZWxzOgogIC0gc25vd2ZsYWtlCmRlcGVuZGVuY2llczoKICAtIHN0cmVhbWxpdD0xLjUyLjIKICAtIHNub3dmbGFrZS1zbm93cGFyay1weXRob24K'')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/runtime_config.json FROM (SELECT REPLACE(BASE64_DECODE_STRING(''''), ''__PORTABLE_TARGET__'', ''__TARGET__'')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/storefront_view.py FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/streamlit_app.py FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE(REPLACE('DECLARE present_count INTEGER; owned_count INTEGER; collision EXCEPTION (-20072,''Existing app requires explicit migration; source is preserved''); BEGIN SHOW STREAMLITS LIKE ''STOREFRONT_DEMO'' IN SCHEMA __TARGET__; SELECT COUNT(*) INTO :present_count FROM TABLE(RESULT_SCAN(LAST_QUERY_ID())) WHERE "name"=''STOREFRONT_DEMO''; IF (:present_count>0) THEN SHOW STREAMLITS LIKE ''STOREFRONT_DEMO'' IN SCHEMA __TARGET__; SELECT COUNT(*) INTO :owned_count FROM TABLE(RESULT_SCAN(LAST_QUERY_ID())) WHERE "name"=''STOREFRONT_DEMO'' AND "comment" IN (''oneshot-source:26_embedded_storefront'',''Embedded Storefront Engine — generated from account discovery'',''Observability Monitor - generated from account discovery'') AND "owner"=CURRENT_ROLE(); IF (:owned_count<>1) THEN RAISE collision; END IF; ELSE CREATE STREAMLIT __TARGET__.STOREFRONT_DEMO FROM ''@__TARGET__.APP_STAGE/source/90d986226f60d975/'' MAIN_FILE=''streamlit_app.py'' QUERY_WAREHOUSE=__WAREHOUSE__ RUNTIME_NAME=''SYSTEM$WAREHOUSE_RUNTIME'' COMMENT=''oneshot-source:26_embedded_storefront''; ALTER STREAMLIT __TARGET__.STOREFRONT_DEMO ADD LIVE VERSION FROM LAST; END IF; END', '__TARGET__', :tgt), '__WAREHOUSE__', :wh));
  ...
  BEGIN
    ...
    IF (:completion_error='') THEN
      ...
      IF (ARRAY_SIZE(:existing_app)=0 OR (:source_missing AND :existing_app[0]:comment::VARCHAR IN ('oneshot-source:26_embedded_storefront','Embedded Storefront Engine — generated from account discovery','Observability Monitor - generated from account discovery'))) THEN
          LET portable_source_revision STRING := '90d986226f60d975';
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/.streamlit/config.toml FROM (SELECT REPLACE(BASE64_DECODE_STRING(''W3Nub3dmbGFrZV0KW3Nub3dmbGFrZS5zbGVlcF0Kc3RyZWFtbGl0U2xlZXBUaW1lb3V0TWludXRlcyA9IF9fUE9SVEFCTEVfU0xFRVBfTUlOVVRFU19fCg==''), ''__PORTABLE_SLEEP_MINUTES__'', LEAST(240, GREATEST(5, COALESCE(TRY_TO_NUMBER($STOREFRONT_APP_SLEEP_MINUTES::VARCHAR), 240)))::VARCHAR)) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/AGENTS.md FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/CUSTOMIZE.md FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/Customize.sql FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/build.py FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/deploy.py FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/environment.yml FROM (SELECT BASE64_DECODE_STRING(''bmFtZTogc2ZfZW52CmNoYW5uZWxzOgogIC0gc25vd2ZsYWtlCmRlcGVuZGVuY2llczoKICAtIHN0cmVhbWxpdD0xLjUyLjIKICAtIHNub3dmbGFrZS1zbm93cGFyay1weXRob24K'')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/runtime_config.json FROM (SELECT REPLACE(BASE64_DECODE_STRING(''''), ''__PORTABLE_TARGET__'', ''__TARGET__'')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/source.json FROM (SELECT BASE64_DECODE_STRING('''')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  stmts := ARRAY_APPEND(:stmts, REPLACE('COPY INTO @__TARGET__.APP_STAGE/source/90d986226f60d975/sql/blocks/payload_extra.sql FROM (SELECT BASE64_DECODE_STRING(''ICAgICAgLCAnY3VzdG9tZXJfY2FuZGlkYXRlcycsIDpjdXN0X2NhbmRzCiAgICAgICwgJ3Byb2R1Y3RfY2FuZGlkYXRlcycsIDpwcm9kX2NhbmRzCg=='')) FILE_FORMAT=(TYPE=CSV COMPRESSION=NONE FIELD_DELIMITER=NONE RECORD_DELIMITER=NONE FIELD_OPTIONALLY_ENCLOSED_BY=NONE ESCAPE_UNENCLOSED_FIELD=NONE) SINGLE=TRUE OVERWRITE=TRUE', '__TARGET__', :tgt));
  ...
  cost_detail := ARRAY_APPEND(:cost_detail, 'Streamlit use is projected at 0.10 credits/day for light XS usage; source copying has additional serverless charges.');
      ...
      IF (:completion_error='') THEN
        ...
        IF (:app_ready) THEN
          ...
          BEGIN
            EXECUTE IMMEDIATE 'SHOW WORKSPACES IN SCHEMA ' || :tgt;
            LET source_exists BOOLEAN := (SELECT COUNT(*)=1 FROM TABLE(RESULT_SCAN(LAST_QUERY_ID())) WHERE "name"='ONESHOT_SOURCE' AND "comment"='oneshot-source:26_embedded_storefront' AND "owner"=CURRENT_ROLE());
